...
sayHelloButton.addEventListener('click', sayHelloColor)
...
const repeatMyParam = () => {
    axios.get('http://localhost:3000/repeat/hello').then((res) => {
        ...
        console.log(document.querySelector('#repeat-text'));
    }
    )
...
// CODE HERE
const queryTest = () => {
    axios.get('http://localhost:3000/query-test/?name=Fred').then((res) => {
        console.log(res);
    }
    )
}
